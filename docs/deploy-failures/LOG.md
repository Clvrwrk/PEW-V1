...
|------|--------|-------|-------|--------------|-------|--------|
| 2026-05-29 | `bc277ea` | `audit:images` | missing-committed-image | no — must `git add` | Stage 2b uncommitted-image check | [link](./2026-05-29-missing-committed-image.md) |
...
| missing-committed-image (file on disk, not in git) | Stage 2b — uncommitted image check | none — must `git add` the file |
